<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-03-30 12:26:57
         compiled from "D:\wamp64\www\gedung\application\views\templates\partials\sidebar_left.html" */ ?>
<?php /*%%SmartyHeaderCode:1015458dcf9912a42c5-64786170%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '87d9b2aeef2330ccf748c19cc04c2b954d6eb8fb' => 
    array (
      0 => 'D:\\wamp64\\www\\gedung\\application\\views\\templates\\partials\\sidebar_left.html',
      1 => 1459216418,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1015458dcf9912a42c5-64786170',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58dcf992244cf8_42034652',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58dcf992244cf8_42034652')) {function content_58dcf992244cf8_42034652($_smarty_tpl) {?><aside id="sidebar-left" class="sidebar-circle">
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_blog']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_blog']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/blog/blog-grid');?>
">Grid</a></li>
        <li class="<?php if (isset($_smarty_tpl->tpl_vars['active_blog_list']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_blog_list']->value;?>
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/blog/blog-list');?>
">List</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/blog/blog-single');?>
">Single</a></li>
    </ul>
</li>
<!--/ End navigation - blog -->
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_mail']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_mail']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/mail/mail-inbox');?>
">Inbox</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/mail/mail-compose');?>
">Compose mail</a></li>
        <li class="<?php if (isset($_smarty_tpl->tpl_vars['active_mail_view']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_mail_view']->value;?>
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/mail/mail-view');?>
">View mail</a></li>
    </ul>
</li>
<!--/ End navigation - mail -->
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_pages']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_pages']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/pages/page-gallery');?>
">Gallery</a></li>
        <li class="<?php if (isset($_smarty_tpl->tpl_vars['active_gallery']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_faq']->value;?>
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/pages/page-faq');?>
...
">Profile</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/pages/page-search-course');?>
">Courses</a></li>
            </ul>
        </li>
 ...
 <?php }?>">
            ...
            <ul>
                <li><a href="<?php echo base_url('production/admin/codeigniter/errors/error-403');?>
" target="_blank">Error 403</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/pages/page-error-403');?>
">Error 403 Type 2</a></li>
                <li><a href="<?php echo base_url('production/admin/codeigniter/errors/error-404');?>
" target="_blank">Error 404</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/pages/page-error-404');?>
">Error 404 Type 2</a></li>
                <li><a href="<?php echo base_url('production/admin/codeigniter/errors/error-500');?>
" target="_blank">Error 500</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/pages/page-error-500');?>
...
" target="_blank">Sign In</a></li>
                <li><a href="<?php echo base_url('production/admin/codeigniter/account/sign-up');?>
" target="_blank">Sign Up</a></li>
                <li><a href="<?php echo base_url('production/admin/codeigniter/account/lost-password');?>
" target="_blank">Lost password</a></li>
                <li><a href="<?php echo base_url('production/admin/codeigniter/account/lock-screen');?>
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_forms']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_forms']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/forms/form-element');?>
">Element</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/forms/form-advanced');?>
">Advanced</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/forms/form-layout');?>
">Layout</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/forms/form-validation');?>
">Validation</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/forms/form-wizard');?>
">Wizard</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/forms/form-wysiwyg');?>
">Text Editor</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/forms/form-xeditable');?>
">X-Editable</a></li>
    </ul>
</li>
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_tables']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_tables']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/tables/table-default');?>
">Default</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/tables/table-color');?>
">Color</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/tables/table-datatable');?>
">Datatable</a></li>
    </ul>
</li>
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_maps']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_maps']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/maps/map-google');?>
">Google</a></li>
        <li class="<?php if (isset($_smarty_tpl->tpl_vars['active_map_vector']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_map_vector']->value;?>
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/maps/map-vector');?>
">Vector</a></li>
    </ul>
</li>
<!--/ End navigation - maps -->
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_charts']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_charts']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/charts/chart-flot');?>
">Flot</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/charts/chart-morris');?>
">Morris</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/charts/chart-chartjs');?>
">Chartjs</a></li>
        <li class="<?php if (isset($_smarty_tpl->tpl_vars['active_chart_c3js']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_chart_c3js']->value;?>
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/charts/chart-c3js');?>
">C3js</a></li>
    </ul>
</li>
...
<li class="submenu <?php if (isset($_smarty_tpl->tpl_vars['active_components']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_components']->value;?>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-grid-system');?>
">Grid System</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-button');?>
">Buttons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-typography');?>
">Typography</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-panel');?>
">Panels</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-alert');?>
">Alerts</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-modal');?>
">Modals</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-video');?>
">Video <span class="label label-danger pull-right">New</span></a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-tabsaccordion');?>
">Tabs & Accordion</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-slider');?>
">Sliders</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-glyphicons');?>
">Glyphicons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-glyphicons-pro');?>
">Glyphicons PRO</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-font-awesome');?>
">Font Awesome</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-weather-icons');?>
">Weather Icons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-map-icons');?>
">Map Icons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-simple-line-icons');?>
">Simple Line Icons</a></li>
 ...
 <?php }?>"><a href="<?php echo base_url('production/admin/codeigniter/components/component-other');?>
">Other</a></li>
    </ul>
</li>
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_animate']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_animate']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('production/admin/codeigniter/animate');?>
">
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_widget_overview']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_widget_overview']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('production/admin/codeigniter/widget/widget-overview');?>
">
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_widget_social']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_widget_social']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('production/admin/codeigniter/widget/widget-social');?>
">
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_widget_blog']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_widget_blog']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('production/admin/codeigniter/widget/widget-blog');?>
">
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_widget_weather']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_widget_weather']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('production/admin/codeigniter/widget/widget-weather');?>
">
...
<li class="<?php if (isset($_smarty_tpl->tpl_vars['active_widget_misc']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['active_widget_misc']->value;?>
 <?php }?>">
    <a href="<?php echo base_url('production/admin/codeigniter/widget/widget-misc');?>
">
